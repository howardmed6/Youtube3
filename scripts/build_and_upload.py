...
def construir_video(data: dict, ruta_media: str, es_video: bool, salida: str = "/tmp/output_video.mp4") -> str:
    ...
    filtros = (
        ...
        f"[base]drawbox=x=0:y=0:w=1080:h={h_sec1}:color=black@0.4:t=fill[dark];"
        ...
        f"[1:v]scale={ancho_poster}:{alto_poster},format=yuv420p[poster];"        f"[sec3b][poster]overlay=10:{y_poster}[con_poster];"
